...
void RegisterGlobals()
{
	...
	RootTable(v)
		...
		.Func(_SC("CreateSprite"), CreateSprite)
		.Func(_SC("CreateTextdraw"), CreateTextdraw)

		.Overload(_SC("CreateVehicle"), CreateVehicle)
		.Overload(_SC("CreateVehicle"), CreateVehicleExpanded)

		.Overload(_SC("CreatePickup"), CreatePickupCompat)
		...
		.Func(_SC("GetPickupCount"), GetVehicleCount)
		.Func(_SC("GetPlayers"), GetPlayers)

		.Func(_SC("GetFallEnabled"), GetFallEnabled)
		.Func(_SC("SetFallEnabled"), SetFallEnabled)
		.Func(_SC("GetDeathmatchScoreboard"), GetDeathmatchScoreboard)
		.Func(_SC("SetDeathmatchScoreboard"), SetDeathmatchScoreboard)
		.Func(_SC("GetWeaponSync"), GetWeaponSync)
		.Func(_SC("SetWeaponSync"), SetWeaponSync)
