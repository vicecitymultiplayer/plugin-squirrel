...
void RegisterGlobals()
{
	...
	RootTable(v)
		...
		.Func(_SC("SetFallTimer"), SetFallTimer, 2, _SC("ti"))
		...
		.Func(_SC("GetFallTimer"), GetFallTimer, 1, _SC("t"))
		...
		.Func(_SC("SetWallglitch"), ToggleWallglitch, 2, _SC("tb"))
		.Func(_SC("SetBackfaceCullingDisabled"), ToggleDisableBackfaceCulling, 2, _SC("tb"))
		.Func(_SC("SetHeliBladeDamageDisabled"), ToggleDisableHeliBladeDamage, 2, _SC("tb"))
		...
		.Func(_SC("GetWallglitch"), EnabledWallglitch, 1, _SC("t"))
