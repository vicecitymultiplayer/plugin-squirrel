...
void RegisterGlobals()
{
	...
	RootTable(v)
		...
		.Func(_SC("ShutdownServer"), ShutdownServer )
		...
		.Func(_SC("SetShowOnlyTeamMarkers"), ToggleShowOnlyTeamMarkers )
		...
		.Func(_SC("SetWallglitch"), ToggleWallglitch )
		...
		.Func(_SC("GetShowOnlyTeamMarkers"), EnabledShowOnlyTeamMarkers )
		...
		.Func(_SC("GetWallglitch"), EnabledWallglitch )
		...
		.Func(_SC("CreateCheckpoint"), CreateCheckpoint )
		.Func(_SC("CreateSphere"), CreateSphere )
		...
		.Func(_SC("FindCheckpoint"), FindCheckpoint )
		.Func(_SC("FindSphere"), FindSphere )
		...
		.Func(_SC("GetPickupCount"), GetPickupCount )
		.Func(_SC("GetObjectCount"), GetObjectCount )
        ...
        .Overload<int (*)(bool, int)>(_SC("BindKey"), BindKey  )
