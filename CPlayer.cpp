...
void RegisterPlayer()
{
	...
	c
		...
		// Functions
		.Func( _SC("AddSpeed"), &CPlayer::AddSpeed, 1, "x" )
		.Func( _SC("Ban"), &CPlayer::Ban, 0, "" )
		.Func( _SC("Disarm"), &CPlayer::Disarm, 0, "" )
		.Func( _SC("Eject"), &CPlayer::Eject, 0, "" )
		.Func( _SC("GetAmmoAtSlot"), &CPlayer::GetAmmoAtSlot, 1, "i" )
		.Func( _SC("GetWeaponAtSlot"), &CPlayer::GetWeaponAtSlot, 1, "i" )
		.Func( _SC("GiveMoney"), &CPlayer::GiveMoney, 1, "i" )
		.Func( _SC("GiveWeapon"), &CPlayer::GiveWeapon, 2, "ii" )
		.Func( _SC("Kick"), &CPlayer::Kick, 0, "" )
		.Func( _SC("RestoreCamera"), &CPlayer::RestoreCamera, 0, "" )
		.Func( _SC("RemoveWeapon"), &CPlayer::RemoveWeapon, 1, "i" )
		.Func( _SC("Select"), &CPlayer::Select, 0, "" )
		.Func( _SC("SetAlpha"), &CPlayer::SetAlpha, 2, "ii" )
		.Overload<void (CPlayer::*)(int, int)>( _SC("SetAnim"), &CPlayer::Animation )
		.Overload<void (CPlayer::*)(int)>( _SC("SetAnim"), &CPlayer::CompatAnimation )
		.Func( _SC("SetCameraPos"), &CPlayer::SetCameraPos, 2, "xx" )
		.Func( _SC("SetInterior"), &CPlayer::SetInterior, 1, "i" )
		.Func( _SC("SetWantedLevel"), &CPlayer::SetWantedLevel, 1, "i" )
		.Func( _SC("SetWeapon"), &CPlayer::SetWeapon, 2, "ii" )
		.Func( _SC("Spawn"), &CPlayer::Spawn, 0, "" )
		.Func( _SC("StreamedToPlayer"), &CPlayer::StreamedToPlayer, 1, "x" );
