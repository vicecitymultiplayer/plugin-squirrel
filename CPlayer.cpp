...
void RegisterPlayer()
{
	...
	c
		.Prop( _SC("Admin"), &CPlayer::GetAdmin, &CPlayer::SetAdmin, "b" )
		.Prop( _SC("Angle"), &CPlayer::GetHeading, &CPlayer::SetHeading, "n" )
		.Prop( _SC("Armor"), &CPlayer::GetArmour, &CPlayer::SetArmour, "n" )
		.Prop( _SC("Armour"), &CPlayer::GetArmour, &CPlayer::SetArmour, "n" )
		.Prop( _SC("CanAttack"), &CPlayer::GetCanAttack, &CPlayer::SetCanAttack, "b" )
		.Prop( _SC("CanDriveby"), &CPlayer::GetDrivebyEnabled, &CPlayer::SetDrivebyEnabled, "b" )
		.Prop( _SC("Cash"), &CPlayer::GetMoney, &CPlayer::SetMoney, "i" )
		.Prop( _SC("Color"), &CPlayer::GetColour, &CPlayer::SetColour, "u|p|x" )
		.Prop( _SC("Colour"), &CPlayer::GetColour, &CPlayer::SetColour, "u|p|x" )
		.Prop( _SC("DrivebyAbility"), &CPlayer::GetDrivebyEnabled, &CPlayer::SetDrivebyEnabled, "b" )
		.Prop( _SC("Frozen"), &CPlayer::GetFrozen, &CPlayer::SetFrozen, "b" )
		.Prop( _SC("GreenScanlines"), &CPlayer::GetGreenScanlines, &CPlayer::SetGreenScanlines, "b" )
		.Prop( _SC("Heading"), &CPlayer::GetHeading, &CPlayer::SetHeading, "n" )
		.Prop( _SC("Health"), &CPlayer::GetHealth, &CPlayer::SetHealth, "n" )
		.Prop( _SC("Immunity"), &CPlayer::GetImmunity, &CPlayer::SetImmunity, "n" )
		.Prop( _SC("IsAdmin"), &CPlayer::GetAdmin, &CPlayer::SetAdmin, "b" )
		.Prop( _SC("IsOnRadar"), &CPlayer::GetOnRadar, &CPlayer::SetOnRadar, "b" )
		.Prop( _SC("Money"), &CPlayer::GetMoney, &CPlayer::SetMoney, "i" )
		.Prop( _SC("Pos"), &CPlayer::GetPosition, &CPlayer::SetPosition, "u|p|x" )
		.Prop( _SC("Score"), &CPlayer::GetScore, &CPlayer::SetScore, "i" )
		.Prop( _SC("SecWorld"), &CPlayer::GetSecWorld, &CPlayer::SetSecWorld, "i" )
		.Prop( _SC("ShowMarkers"), &CPlayer::ShowingMarkers, &CPlayer::ShowMarkers, "b" )
		.Prop( _SC("Slot"), &CPlayer::GetWeaponSlot, &CPlayer::SetWeaponSlot, "i" )
		.Prop( _SC("Skin"), &CPlayer::GetSkin, &CPlayer::SetSkin, "i" )
		.Prop( _SC("Team"), &CPlayer::GetTeam, &CPlayer::SetTeam, "i" )
		.Prop( _SC("Vehicle"), &CPlayer::GetVehicle, &CPlayer::SetVehicle, "u|p|x" )
		.Prop( _SC("WhiteScanlines"), &CPlayer::GetWhiteScanlines, &CPlayer::SetWhiteScanlines, "b" )
		.Prop( _SC("Widescreen"), &CPlayer::GetWidescreen, &CPlayer::SetWidescreen, "b" )
		.Prop( _SC("World"), &CPlayer::GetWorld, &CPlayer::SetWorld, "i" )
		...
		// Functions
		.Func( _SC("AddSpeed"), &CPlayer::AddSpeed, 2, "tu|p|x" )
		.Func( _SC("Ban"), &CPlayer::Ban, 1, "t" )
		.Func( _SC("Disarm"), &CPlayer::Disarm, 1, "t" )
		.Func( _SC("Eject"), &CPlayer::Eject, 1, "t" )
		.Func( _SC("GetAmmoAtSlot"), &CPlayer::GetAmmoAtSlot, 2, "ti" )
		.Func( _SC("GetWeaponAtSlot"), &CPlayer::GetWeaponAtSlot, 2, "ti" )
		.Func( _SC("GiveMoney"), &CPlayer::GiveMoney, 2, "ti" )
		.Func( _SC("GiveWeapon"), &CPlayer::GiveWeapon, 3, "tii" )
		.Func( _SC("Kick"), &CPlayer::Kick, 1, "t" )
		.Func( _SC("RestoreCamera"), &CPlayer::RestoreCamera, 1, "t" )
		.Func( _SC("RemoveWeapon"), &CPlayer::RemoveWeapon, 2, "ti" )
		.Func( _SC("Select"), &CPlayer::Select, 1, "t" )
		.Func( _SC("SetAlpha"), &CPlayer::SetAlpha, 3, "tii" )
		.Overload<void (CPlayer::*)(int, int)>( _SC("SetAnim"), &CPlayer::Animation, 3, "tii" )
		.Overload<void (CPlayer::*)(int)>( _SC("SetAnim"), &CPlayer::CompatAnimation, 2, "ti" )
		.Func( _SC("SetCameraPos"), &CPlayer::SetCameraPos, 3, "tu|p|xu|p|x" )
		.Func( _SC("SetInterior"), &CPlayer::SetInterior, 2, "ti" )
		.Func( _SC("SetWantedLevel"), &CPlayer::SetWantedLevel, 2, "ti" )
		.Func( _SC("SetWeapon"), &CPlayer::SetWeapon, 3, "tii" )
		.Func( _SC("Spawn"), &CPlayer::Spawn, 1, "t" )
		.Func( _SC("StreamedToPlayer"), &CPlayer::StreamedToPlayer, 2, "tu|p|x" );
